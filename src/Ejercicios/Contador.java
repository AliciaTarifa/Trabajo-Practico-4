 ...
 * - Constructor con parámetros para inicializar el contador con un valor no negativo. Si el valor inicial que se recibe es negativo 
 * el contador tomará el valor cero como valor inicial.
 * - Constructor copia.
 * Además de los métodos getter y setter, la clase contendrá los métodos:
 * - incrementar: incrementa el contador en una unidad.
 * - decrementar: decrementa el contador en una unidad. El contador nunca podrá tener un valor negativo. Si al decrementar se alcanza 
